...
gps_2008 <- gps_2008 %>%
  ...
  mutate(
    proche_AP_pre2008 = st_within(geometry, buffer_10km_before_2008, sparse = FALSE)[, 1],
    proche_AP_post2008 = st_within(geometry, buffer_10km_after_2008, sparse = FALSE)[, 1],
    groupe = case_when(
  ...
  mutate(
    distance_pre2008 = st_distance(geometry, st_union(buffer_10km_before_2008)),
    distance_post2008 = st_distance(geometry, st_union(buffer_10km_after_2008)),
