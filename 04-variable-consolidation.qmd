...
hr_1997_final <- build_year(
  year = 1997,
  hr_path = "data/raw/dhs/DHS_1997/MDHR31DT/MDHR31FL.DTA",
  hh_rural_path = "data/derived/hh_1997_rural.rds",
  spei_years = 1995:1997
)

hr_2008_final <- build_year(
  year = 2008,
  hr_path = "data/raw/dhs/DHS_2008/MDHR51DT/MDHR51FL.DTA",
  hh_rural_path = "data/derived/hh_2008_rural.rds",
  spei_years = 2006:2008
)

hr_2011_final <- build_year(
  year = 2011,
  hr_path = "data/raw/dhs/DHS_2011/MDHR61DT/MDHR61FL.DTA",
  hh_rural_path = "data/derived/hh_2011_rural.rds",
  spei_years = 2009:2011
)

hr_2013_final <- build_year(
  year = 2013,
  hr_path = "data/raw/dhs/DHS_2013/MDHR6ADT/MDHR6AFL.DTA",
  hh_rural_path = "data/derived/hh_2013_rural.rds",
  spei_years = 2011:2013
)

hr_2016_final <- build_year(
  year = 2016,
  hr_path = "data/raw/dhs/DHS_2016/MDHR71DT/MDHR71FL.DTA",
  hh_rural_path = "data/derived/hh_2016_rural.rds",
  spei_years = 2014:2016
)

hr_2021_final <- build_year(
  year = 2021,
  hr_path = "data/raw/dhs/DHS_2021/MDHR81DT/MDHR81FL.DTA",
  hh_rural_path = "data/derived/hh_2021_rural.rds",
