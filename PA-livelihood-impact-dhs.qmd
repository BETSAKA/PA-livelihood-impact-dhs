...
gps_cluster_2008 <- gps_cluster_2008 %>%
  mutate(
    distance_AP_post2008 = st_distance(geometry, sapm_land_post2008_buffer),
    groupe = case_when(
      as.numeric(distance_AP_post2008) > 10000 & 
      !proche_AP_post2008 & 
...
gps_cluster_2008 <- gps_cluster_2008 %>%
  mutate(
    distance_AP_pre2008 = st_distance(geometry, sapm_land_pre2008_buffer),
    distance_AP_post2008 = st_distance(geometry, sapm_land_post2008_buffer),
    groupe = case_when(
      as.numeric(distance_AP_post2008) > 10000 & 
        !proche_AP_post2008 & 
      ...
      as.numeric(distance_AP_pre2008) < 10000 & 
        !proche_AP_post2008 & 
        URBAN_RURA == "R" ~ "Exclu",
      TRUE ~ groupe
    )
...
results_rural <- list(
  statistics_rural_2008 <- clusters_and_households(
  ...
  statistics_rural_2021 <- clusters_and_households(
...
# Ajout de colonne pour catégoriser les zones 
combined_results <- bind_rows(
  results_all %>% mutate(Type = "Toutes observations"),
  results_rural %>% mutate(Type = "Zones rurales") 
