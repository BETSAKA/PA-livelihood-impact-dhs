...
tm_shape(sapm_land_post2008_buffer) +
  ...
  tm_add_legend("fill", col = c("blue", "red"), labels = c("AP créées après 2008", "AP créées après 2008")) +
  tm_title("Aires protégées de Madagascar avec les buffers de 10 km")
```

## Identification du groupe de traitement
...
## Identification du groupe de contrôle
