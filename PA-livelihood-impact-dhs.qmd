...
matching_2008 <- gps_cluster_2008 %>%
  ...
  mutate(treatment = ifelse(groupe == "Traitement", 1, 0))
...
matching_2008 <- matchit(
  groupe == "Traitement" ~ treecover_area + slope + elevation + population_count + traveltime_2000,
...
# Vérifiez les valeurs uniques de la variable treatment
unique(matching_2008$treatment)
```
