...
if (file.exists("Data/household_cluster_2008/household_cluster_2008_05.rds")) {
  ...
  tic()
  with_progress({
    household_cluster_2008_01 <- calc_indicators(
      x = household_cluster_2008, calc_treecover_area(years = 2000, min_size = 10, min_cover = 35))
  })
  toc()   
  ...
  tic()
  with_progress({
    household_cluster_2008_02 <- calc_indicators(
  ...
  tic()
  with_progress({
    household_cluster_2008_03 <- calc_indicators(
  ...
  tic()
  with_progress({
    household_cluster_2008_04 <- calc_indicators(
  ...
  tic()
  with_progress({
    household_cluster_2008_05 <- calc_indicators(
  ...
  write_rds(x = household_cluster_2008, file = "Data/indicators_2008/household_cluster_2008_05.rds")
}
...
# Forest cover rate in 2000
  tic()
  with_progress({
    household_cluster_2021 <- calc_indicators(x = household_cluster,
...
# slope
  tic()
  with_progress({
    household_cluster_2021 <- calc_indicators(x = household_cluster_2021,
                                                 calc_slope())
  })
  toc()   
