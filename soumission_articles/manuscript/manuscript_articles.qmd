...
```         
Notes: Households in the treatment group are those located in clusters less than 10 km from PAs created since 2008 in rural areas (shown in red) and households are those located in clusters more than 10 km from PAs created since 2008 in rural areas (shown in blue). Rural populations living within 10 km of PAs created before 2008 or located in urban areas are excluded from the study (shown in black). The GPS data used comes from DHS clusters. 
```
