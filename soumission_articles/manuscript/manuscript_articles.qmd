...
The result show that the coefficients associated with the treatment periods overlap 0. The parallel trend hypothesis is verified. At the time the PA were implemented, the household wealth index was farily positive? even though the result is not significant. This effect deterorated after two to three years and intensified significantly in the long term. 
