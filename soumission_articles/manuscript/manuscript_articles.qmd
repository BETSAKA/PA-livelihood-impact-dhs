...
@tbl-period-crea shows the distribution of terrestrial PAs (by number and area) according to the period in which they were created by final decree, taking 2008 as the reference year. In the treatment period (2008 to 2021), 103 PAs were created, covering 75,252 km².
...
The data on household living conditions used for this study comes from surveys conducted by the “Institut National de la Statistique de Madagascar” (INSTAT) as part of the Demographic and Health Surveys (DHS)[^3].These data covers a wide range of topics, including demographic characteristics, living conditions, health, education, sanitation, and hygiene. These surveys were conducted 1997, 2008, and 2021, containing 650 clusters in 2021[^4], 585 in 2008[^5], and 268 in 1997[^6].
