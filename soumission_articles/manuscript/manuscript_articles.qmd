...
*Source: Author’s elaboration based on DHS data (1997, 2008, 2021).*
...
${Treatment}_c$: Binary variable that takes the value of 1 if cluster $c$ is located in an area affected by a protected area, and 0 otherwise (control households)
