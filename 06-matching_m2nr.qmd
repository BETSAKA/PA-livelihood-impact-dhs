...
if (file.exists("data/derived/gen_match_model_1997_m2nr.rds")) {
  gen_match_model_1997_m2nr <- readRDS("data/derived/gen_match_model_1997_m2nr.rds")
} else {
  
  gen_match_model_1997_m2nr <- GenMatch(
    Tr = matching_1997$treatment,
    X = X_match,
    BalanceMatrix = X_match,
    estimand = "ATT",
    M = 2, # 2 appariement pour chaque unité du groupe de traitement
    replace = FALSE,
    weights = NULL,
    pop.size = 1000, 
    max.generations = 100,
  ...
  saveRDS(gen_match_model_1997_m2nr, "data/derived/gen_match_model_1997_m2nr.rds")
  cat("Modèle GenMatch enregistré. \n")
}

# Matching with MatchIt for 1997  
  if (file.exists("data/derived/matching_result_1997_m2nr.rds")) {
  matching_result_1997_m2nr <- readRDS("data/derived/matching_result_1997_m2nr.rds")
} else {
  cat("Fichier introuvable, début du traitement...\n")
  matching_result_1997_m2nr <- matchit(
    treatment ~ treecover_area_2000 + slope_2000 + elevation_2000 + population_count_2000 + traveltime_2000_2000,
    data = matching_1997,
    method = "genetic",
    distance = "mahalanobis",
    gen.match = gen_match_model_1997_m2nr,
    ratio = 2,
    replace = FALSE,
    caliper = 0.25
  )
  # Registrement
  saveRDS(matching_result_1997_m2nr , "data/derived/matching_result_1997_m2nr.rds")
  cat("Données enregistrées")
}

# Summary of Balance
summary(matching_result_1997_m2nr)
plot(matching_result_1997_m2nr)

# Extract matched data for 1997
data_matched_1997_m2nr <- match.data(matching_result_1997_m2nr)

data_matched_1997_m2nr <- data_matched_1997_m2nr %>%
  filter(weights > 0)
nrow(data_matched_1997_m2nr)

saveRDS(data_matched_1997_m2nr,"data/derived/data_matched_1997_m2nr.rds" )
```
...
if (file.exists("data/derived/gen_match_model_2008_m2nr.rds")) {
  gen_match_model_2008_m2nr <- readRDS("data/derived/gen_match_model_2008_m2nr.rds")
} else {
  cat("Fichier introuvable, début du traitement...\n")
  
  gen_match_model_2008_m2nr <- GenMatch(
    Tr = matching_2008$treatment,
    X = X_match,
    BalanceMatrix = X_match,
    estimand = "ATT",
    M = 2, # 2 appariements pour chaque unité du groupe de traitement
    replace = FALSE,
    weights = NULL,
    pop.size = 1000, 
    max.generations = 100,
  ...
  saveRDS(gen_match_model_2008_m2nr, "data/derived/gen_match_model_2008_m2nr.rds")
  cat("Modèle GenMatch enregistré. \n")
}

# Matching with MatchIt for 2008  
  if (file.exists("data/derived/matching_result_2008_m2nr.rds")) {
  matching_result_2008_m2nr <- readRDS("data/derived/matching_result_2008_m2nr.rds")
} else {
  cat("Fichier introuvable, début du traitement...\n")
  matching_result_2008_m2nr <- matchit(
    treatment ~ treecover_area_2000 + slope_2000 + elevation_2000 + population_count_2000 + traveltime_2000_2000,
    data = matching_2008,
    method = "genetic",
    distance = "mahalanobis",
    gen.match = gen_match_model_2008_m2nr,
    ratio = 2,
    replace = FALSE,
    caliper = 0.25
  )
  # Registrement
  saveRDS(matching_result_2008_m2nr , "data/derived/matching_result_2008_m2nr.rds")
  cat("Données enregistrées")
}

# Summary of Balance
summary(matching_result_2008_m2nr)
plot(matching_result_2008_m2nr)

# Extract matched data for 2008
data_matched_2008_m2nr <- match.data(matching_result_2008_m2nr)

data_matched_2008_m2nr <- data_matched_2008_m2nr %>%
  filter(weights > 0)
nrow(data_matched_2008_m2nr)

saveRDS(data_matched_2008_m2nr,"data/derived/data_matched_2008_m2nr.rds" )
```
...
if (file.exists("data/derived/gen_match_model_2021_m2nr.rds")) {
  gen_match_model_2021_m2nr <- readRDS("data/derived/gen_match_model_2021_m2nr.rds")
} else {
  cat("Fichier introuvable, début du traitement...\n")
  
  gen_match_model_2021_m2nr <- GenMatch(
  ...
  saveRDS(gen_match_model_2021_m2nr, "data/derived/gen_match_model_2021_m2nr.rds")
  cat("Modèle GenMatch enregistré. \n")
}

# Matching with MatchIt for 2021  
  if (file.exists("data/derived/matching_result_2021_m2nr.rds")) {
  matching_result_2021_m2nr <- readRDS("data/derived/matching_result_2021_m2nr.rds")
} else {
  cat("Fichier introuvable, début du traitement...\n")
  
  matching_result_2021_m2nr <- matchit(
    treatment ~ treecover_area_2000 + slope_2000 + elevation_2000 + population_count_2000 + traveltime_2000_2000,
    data = matching_2021,
    method = "genetic",
    distance = "mahalanobis",
    gen.match = gen_match_model_2021_m2nr,
    ratio = 2,
    replace = FALSE,
    caliper = 0.25
  )
  # Registrement
  saveRDS(matching_result_2021_m2nr , "data/derived/matching_result_2021_m2nr.rds")
  cat("Données enregistrées")
}

# Summary of Balance
summary(matching_result_2021_m2nr)
plot(matching_result_2021_m2nr)

# Extract matched data for 2021
data_matched_2021 <- match.data(matching_result_2021_m2nr)

data_matched_2021_m2nr <- data_matched_2021_m2nr %>%
  filter(weights > 0)
nrow(data_matched_2021_m2nr)

saveRDS(data_matched_2021_m2nr,"data/derived/data_matched_2021_m2nr.rds" )
```
