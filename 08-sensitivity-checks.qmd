...
Il se peut que dans l’analyse, la variable de résultat soit corrélée avec des éléments non observés ou des chocs au niveau du ménage. Des méthodes d’effets fixes permettent de corriger ces facteurs, mais on ne dispose ici que des données en coupe transversales répétées. On peut toutefois contourner cette difficulté en utilisant une approche de pseudo panel pour estimer les modèles à effets fixes à l’échelle de cohortes des ménages @deaton1985. L'approche du pseudo panel permet de construire des pseudos individus en regroupant les individus réels en cohortes. Ces variables de regroupement doivent être également exogènes, invariantes dans le temps et disponibles pour tous les ménages dans les données (p.ex. Année de naissance, région…). Cela permet de garantir que la variation au sein des cohortes ne biaise pas les résultats et que les caractéristiques utilisées pour regrouper les ménages restent constantes au fil du temps.
...
# Calcul des moyennes au niveau cohorte x année
