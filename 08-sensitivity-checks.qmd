...
-   [**Outcome:**]{.underline} wealth index
...
-   [**Outcome:**]{.underline} zscore du wealth index

Après correction FDR, aucune des estimations ne demeure statistiquement significative. Les signaux positifs observés dans l'estimation classique pourraient refléter des fluctuations aléatoires plutôt qu'un effet causal robuste.
...
# Summary avec erreurs standard robustes clusterisées par cluster
summary(fe_model_wealth, cluster = ~ hv001)

# Summary avec erreurs standard robustes clusterisées par année
summary(fe_model_wealth, cluster = ~ DHSYEAR)

# Summary avec erreurs standard robustes clusterisées par année
summary(fe_model_wealth, se = "hetero")
...
summary(fe_model_zscore, cluster = ~ hv001) # SE robustes par cluster
summary(fe_model_wealth, cluster = ~ DHSYEAR) # SE robustes par année
summary(fe_model_wealth, se = "hetero") # SE robustes hétéroscédastiques 
```
