...
Après le matching, nous comptons 5124 groupes appariées pour l'année 1997, 13364 pour 2008, 6025 pour 2011, 6375 pour 2013, 9295 pour 2016 et 15364 pour 2021.

##### Checking covariate balance

Nous allons vérifier l'équilibre relatif des variables mesurées dans des unités différentes avant le matching pour mesurer l'écart entre les moyennes des covariables dans les groupes de traitement et de contrôle

```{r}
# Balance test before matching
data_matched_1997_5km <- read_rds("data/derived/data_matched_1997_5km.rds")
data_matched_2008_5km <- read_rds("data/derived/data_matched_2008_5km.rds")
data_matched_2011_5km <- read_rds("data/derived/data_matched_2011_5km.rds")
data_matched_2013_5km <- read_rds("data/derived/data_matched_2013_5km.rds")
data_matched_2016_5km <- read_rds("data/derived/data_matched_2016_5km.rds")
data_matched_2021_5km <- read_rds("data/derived/data_matched_2021_5km.rds")
...
res_1997_5km  <- check_balance_before(data_matched_1997_5km, 1997, matching_variables)
res_2008_5km  <- check_balance_before(data_matched_2008_5km, 2008, matching_variables)
res_2011_5km  <- check_balance_before(data_matched_2011_5km, 2011, matching_variables)
res_2013_5km  <- check_balance_before(data_matched_2013_5km, 2013, matching_variables)
res_2016_5km  <- check_balance_before(data_matched_2016_5km, 2016, matching_variables)
res_2021_5km  <- check_balance_before(data_matched_2021_5km, 2021, matching_variables)

# Distribution des covariables
data_list <- list(
  "1997" = data_matched_1997_5km,
  "2008" = data_matched_2008_5km,
  "2011" = data_matched_2011_5km,
  "2013" = data_matched_2013_5km,
  "2016" = data_matched_2016_5km,
  "2021" = data_matched_2021_5km 
)
...
print(density_plot(data_matched_1997_5km, 1997, matching_variables))
print(density_plot(data_matched_2008_5km, 2008, matching_variables))
print(density_plot(data_matched_2011_5km, 2011, matching_variables))
print(density_plot(data_matched_2013_5km, 2013, matching_variables))
print(density_plot(data_matched_2016_5km, 2016, matching_variables))
print(density_plot(data_matched_2021_5km, 2021, matching_variables))
```
