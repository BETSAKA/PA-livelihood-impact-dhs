...
desc_AP_before <- get_descriptive_stats(sapm_before_2008, "Before 2008")
desc_AP_from   <- get_descriptive_stats(sapm_from_2008, "From 2008")
...
top10_before_2008 <- get_top_small_aires(sapm_before_2008, "Before 2008")
top10_from_2008  <- get_top_small_aires(sapm_from_2008, "From 2008")
...
```{r}
# On charge les données
hh_1997_rural <- readRDS("data/derived/hh_1997_rural.rds")
...
```{r}
# On charge les données
hh_2008_rural <- readRDS("data/derived/hh_2008_rural.rds")
...
```{r}
# On charge les données
hh_2021_rural <- readRDS("data/derived/hh_2021_rural.rds")
