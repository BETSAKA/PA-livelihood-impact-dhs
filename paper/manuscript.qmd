...
![](figures/map-clust.png){#fig-map-clust width="80%" fig-cap="Classification of household clusters according to their group affiliation."}
...
## Departures and complements to the preanalysis plan {#departuresandcomplementstothepreanalysisplan}
...
![Distribution of the rural wealth index (percentile)](figures/distr_wi.png){#fig-distr-wi width="80%"}
...
![Distribution of the Zscore of the rural wealth index (percentile)](figures/distr_zs.png){#fig-distr-zs width="80%"}
...
![Covariate balance before matching (2008))](figures/density_before_2008.png){#fig-before-2008 width="80%"}

*Source: Authors*

![Covariate balance after matching (2008))](figures/density_after_2008.png){#fig-after-2008 width="80%"}
...
tbl_did2s_static_WI <- read_rds("tables/table_DID_WI.rds")
...
```{r}
#| label: fig-rel-years
#| fig-cap: "Binning of relative years-to-treatment for the event study"
#| fig-width: 10
#| fig-height: 6
#| warning: false
#| message: false
...
p <- read_rds("figures/count_binned_obs_plot.rds")
