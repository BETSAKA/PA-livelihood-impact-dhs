...
#figure([
#box(image("figures/map-clust.png", width: 80.0%))
], caption: figure.caption(
separator: "", 
position: top, 
[
...
$ Y_(i c t) = alpha + delta dot.op \( upright(T r e a t m e n t)_c times upright(P o s t)_t \) + X'_(i c t) theta + mu_c + lambda_t + epsilon_(i c t) $ With the parameters defined as:
...
#figure([
#box(image("figures/distr_zs.png", width: 80.0%))
], caption: figure.caption(
position: top, 
[
...
The distribution analysis of covariates prior to matching shows a substantial imbalance between the treatment and control groups (2008 case in the #ref(<tbl-balance-long-2008>, supplement: [Table])). After matching, the SMDs improve for all variables in each year. However, the population density in 2000 remains the most difficult variable to balance. This reflects the fact that PAs are not randomly distributed. The #ref(<fig-before-2008>, supplement: [Figure]) shows the difference in covariates between the two groups.
...
#{set text(font: ("system-ui", "Segoe UI", "Roboto", "Helvetica", "Arial", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji") , size: 12pt); table(
  ...
  table.header(table.cell(align: center, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.25em , weight: "regular" , fill: rgb("#333333")); Covariates balance before and after matching],
    table.cell(align: bottom + left, rowspan: 2, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); Variable], table.cell(align: center, colspan: 2, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); #block[
    2008
    ]], table.cell(align: center, colspan: 2, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); #block[
    2021
    ]],
    table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); Before matching], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); After matching], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); Before matching], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); After matching],),
  table.hline(),
...
#figure([
#box(image("figures/density_before_2008.png", width: 80.0%))
], caption: figure.caption(
position: top, 
[
...
#figure([
#box(image("figures/density_after_2008.png", width: 80.0%))
], caption: figure.caption(
position: top, 
[
...
=== Estimation DID 2X2
<estimation-did-2x2>
In our DID estimation, we used robust standard errors. The results indicate no statistically significant difference at the 5% level between treated and control households. #ref(<fig-h1-2x2>, supplement: [Figure]) presents the results of the 2x2 DID estimation comparing the treatment groups (households living within 10 km of a PAs) and the control groups (households more than 10 km away) prior to (1997-2008) and after (2008-2021) the PAs establishment.

#figure([
#{set text(font: ("system-ui", "Segoe UI", "Roboto", "Helvetica", "Arial", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji") , size: 12pt); table(
  columns: 3,
  align: (left,center,center,),
  table.header(table.cell(align: bottom + left, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); ], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); Placebo 97-08], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 1.0em , weight: "regular" , fill: rgb("#333333")); Traitement 08-21],),
  table.hline(),
