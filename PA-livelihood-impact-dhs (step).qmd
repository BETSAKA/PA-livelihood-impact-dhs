...
2.  *Recalculer le wealth index hv270a pour 1997 et 2008*
...
-   [Groupe de traitement]{.underline}: ménage vivant dans ou à moins à 10 km des aires protégées entre 2008 et 2021
...
-   [Groupe de traitement]{.underline}: ménage vivant dans ou à moins à 5 km des aires protégées entre 2008 et 2021

-   [Groupe de contrôle]{.underline}: ménage vivant à plus de 5 km des aires protégées entre 2008 et 2021
...
Les ménages prises en compte dans l'analyse sont:

-   Les ménages proches des aires protégées créées à partir de 2008
...
1.  Création d'un groupe de traitement placebo basé sur les ménages de 1997 (traitement= ménages situés à **≤** 5 km des aires protégées créées entre 2008 et 2021)
...
##### Modélisation du modèle DID

Estimation du modèle DID en utilisant des erreurs standards robustes aux corrélations intra-grappes pour gérer la dépendance des observations au sein des grappes:

1.  calcul des résidus à partir du modèle de régression

2.  Utilisation des résidus calculés pour construire une matrice variance-covariance robuste, qui va ajuster la corrélation intra-grappe

### Test pour une distance de 15km

#### Treatment and Control groups assignment

-   [Groupe de traitement]{.underline}: ménage vivant dans ou à moins à 15 km des aires protégées entre 2008 et 2021

-   [Groupe de contrôle]{.underline}: ménage vivant à plus de 15 km des aires protégées entre 2008 et 2021

#### Création du Buffer zone

-   Création d'un buffer de 15 km autour des aires protégées
...
1.  Création d'un groupe de traitement placebo basé sur les ménages de 1997 (traitement= ménages situés à **≤** 15 km des aires protégées créées entre 2008 et 2021)
