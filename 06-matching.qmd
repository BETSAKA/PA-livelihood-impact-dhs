...
Le test après appariement sera un test visuel de la qualité du matching en comparant la distribution de chaque covariable à partir d'un plot. Dans le cas où le QQ plot se situe en diagonale, le quantile des 2 distributions sont similaires.
...
ggplot(matching_before_2008, aes(x = value, fill = GROUP)) +
  ...
  labs(
    tittle = "Distribution des covariables avant matching (2008)",
...
values_to = "value"
  ...
  ggplot(matching_after_2008, aes(x = value, fill = GROUP)) +
    ...
    scale_fill_manual(values = c("Control" = "green", "Treatment" = "blue")) +
    labs(
      title = "Distribution des covariables après matching (2008)",
      x = "Valeur de la covariable",
      y = "Densité",
      fill = "Groupe"
    ) +
...
ggplot(matching_before_2021, aes(x = value, fill = GROUP)) +
  ...
  scale_fill_manual(values = c("Control" = "green", "Treatment" = "blue")) +
  labs(
    tittle = "Distribution des covariables avant matching (2021)",
    x = "Valeur de la covariable",
    y = "Densité",
    fill = "Groupe"
  ) +
...
values_to = "value"
  ...
  ggplot(matching_after_2021, aes(x = value, fill = GROUP)) +
    ...
    scale_fill_manual(values = c("Control" = "green", "Treatment" = "blue")) +
    labs(
      title = "Distribution des covariables après matching (2021)",
      x = "Valeur de la covariable",
      y = "Densité",
      fill = "Groupe"
    ) +
