...
# Load 
hr_list <- setNames(
  lapply(years, function(y) read_rds(paste0("data/derived/hr_", y, "_final.rds"))),
  yrs
)
...
print(density_plot(hr_final_1997, 1997, matching_variables))
print(density_plot(hr_final_2008, 2008, matching_variables))
print(density_plot(hr_final_2011, 2011, matching_variables))
print(density_plot(hr_final_2013, 2013, matching_variables))
print(density_plot(hr_final_2016, 2016, matching_variables))
print(density_plot(hr_final_2021, 2021, matching_variables))
```
