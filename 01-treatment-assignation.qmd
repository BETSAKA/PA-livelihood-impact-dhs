...
tm_add_legend(type = "polygons", fill = c("blue", "darkgreen"), labels = c("avant 2008", "après 2008")) +
  tm_title("Aires protégées par\npériode de création", fontface = "bold", size = 1) +
...
# Enregistre le tableau en CSV
write.csv(summary_table, "data/derived/summary_table.csv", row.names = FALSE)


write_rds(summary_table, "soumission_articles/manuscript/table/tbl-period-crea")
