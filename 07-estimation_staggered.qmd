...
tab_fixest <- modelsummary(
  list("Placebo 97-08" = m_pre, "Traitement 08-21" = m_main), output = "gt"
)

saveRDS(tab_fixest, "soumission_articles/manuscript/table/table_DID_WI.rds")
...
h1_2x2_table <- modelsummary(
  list(
    "DID 2x2 placebo (1997-2008)" = h1_m_pre_2x2, 
    "DID 2x2 (2008-2021)" = h1_m_main_2x2
    )
    )
write_rds(h1_2x2_table, "soumission_articles/manuscript/figures/h1_2x2_table.rds")
h1_2x2_table
```
...
write_rds(count_binned_obs_plot, "soumission_articles/figures/count_binned_obs_plot.rds")
...
saveRDS(did2s_es_2yr, "soumission_articles/manuscript/table/did2s_es_2yr.rds")
...
saveRDS(tab_fixest, "soumission_articles/manuscript/table/table_DID_zscore.rds")
...
saveRDS(did2s_es_2yr, "soumission_articles/manuscript/table/did2s_es_2yr_zscore.rds")
