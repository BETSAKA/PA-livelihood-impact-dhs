...
h1_m_pre_2x2 <- feols(f_pre, data = pre, weights = ~ w_all, cluster = ~ cluster_uid)
...
h1_m_main_2x2 <- feols(f_main, data = main, weights = ~ w_all, cluster = ~ cluster_uid)

etable(h1_m_pre_2x2, h1_m_main_2x2, 
  headers = c("Placebo 97–08", "Traitement 08–21"))

tab_fixest <- modelsummary(
  list("Placebo 97-08" = h1_m_pre_2x2, "Traitement 08-21" = h1_m_main_2x2), output = "gt"
)

saveRDS(tab_fixest, "paper/tables/table_DID_WI.rds")
...
did_df <- bind_rows(
  did_row(h1_m_pre_2x2, 2008),
  did_row(h1_m_main_2x2, 2021)
) %>%
...
write_rds(count_binned_obs_plot, "paper/figures/count_binned_obs_plot.rds")
count_binned_obs_plot
```
...
write_rds(h1_staggered_static_tb, "paper/tables/h1_staggered_static_tb.rds")
...
saveRDS(did2s_es_2yr, "paper/tables/did2s_es_2yr.rds")
...
write_rds(h1_event_study_plot, "paper/figures/h1_event_study_plot.rds")
...
tab_fixest <- modelsummary(
  list("Placebo 97–08" = m_pre, "Traitement 08–21" = m_main),
  output = "gt"
)

saveRDS(tab_fixest, "paper/tables/table_DID_zscore.rds")
...
write_rds(h2_2x2_plot, "paper/figures/h2_2x2_plot.rds")
```
...
write_rds(h2_staggered_static_tb, "paper/tables/h2_staggered_static_tb.rds")
...
saveRDS(did2s_es_2yr, "paper/tables/did2s_es_2yr_zscore.rds")
...
write_rds(h2_event_study_plot, "paper/figures/h2_event_study_plot.rds")
...
write_rds(h3_2x2_plot, "paper/figures/h3_2x2_plot.rds")
...
write_rds(h3_staggered_static_tb, "paper/tables/h3_staggered_static_tb.rds")
...
write_rds(h3_event_study_plot, "paper/figures/h3_event_study_plot.rds")
