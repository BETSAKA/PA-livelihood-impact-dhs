...
# Dictionnaire de noms de variables 
var_labels <- c(
...
tab_fixest <- modelsummary(
  list("Placebo 97-08" = h1_m_pre_2x2, "Traitement 08-21" = h1_m_main_2x2),
  coef_rename = var_labels, output = "gt"
)
...
modelsummary(
  ...
  title  = "Impact on well-being: 2x2 DiD",
  notes  = "Standard errors clustered at the survey cluster level.",
  output = "Presentation/conference_betsaka/tables/h1_2x2_table.tex"
)
```
