...
saveRDS(did2s_static, "soumission_articles/manuscript/table/did2s_static_WI.rds")
```
...
etable(did2s_static, headers = "Static estimation on z-score of wealth index")

saveRDS(did2s_static, "soumission_articles/manuscript/table/did2s_static_zscore.rds")
```
