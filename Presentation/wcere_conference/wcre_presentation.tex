...
\urlstyle{same}
\hypersetup{
  pdftitle={Socioeconomic impacts of Terrestrial Protected Areas},
...
Areas}{Socioeconomic impacts of Terrestrial Protected Areas}}
\subtitle{\texorpdfstring{Evidence from Large-Scale National Surveys in
Madagascar}{Evidence from Large-Scale National Surveys in Madagascar}}
...
\(^{2}\)Université Versailles Saint Quentin \(\quad\) \(^{3}\)Agence
...
living standards?}
\protect\phantomsection\label{to-what-extent-do-protected-areas-pa-impact-household-living-standards}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/result_H1.png}
\end{frame}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/result_H2.png}
\end{frame}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/result_H3.png}
\end{frame}
...
\tightlist
\item
  \textbf{Distance threshold test of 5 km and 15km}: Proximity to
  protected areas (PA) has no significant effect on wealth
\item
  ...
  stronger influence on household living standards than sociodemographic
  characteristics
\item
...
\item
  No significant average effect on the standards of living - losses
...
\textbf{Policy Implications}: - Integration of systematic socioeconomic
monitoring into protected area governance frameworks - Strengthening of
transparent compensation mechanisms - Design of inclusive
benefit-sharing mechanisms that address equity concerns
\end{frame}
...
\begin{frame}[shrink]{Matching}
\protect\phantomsection\label{matching-1}
\hypertarget{annexe-evolution-PA}{}
