...
\begin{itemize}
\item
  Analysis covering \textbf{71 terrestrial PA} established between 2008
  and 2021
\item
  it articulates econometrics models, incorporating recent developments
  to adapt these methods to the study of PA.
\end{itemize}
\end{frame}
...
\textbf{Policy Implications}: - Addressing questions about the local
socioeconomic impact of protected areas - Understanding the determinants
of these impacts: protected area governance and management modalities
\end{frame}
