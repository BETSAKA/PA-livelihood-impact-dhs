...
subtitle: "WCRE Conference, Lisbon -- 29 june - 3 july 2026"
author: 
  - name: "**Iriana Razafimahenina**$^{1,4}$"
  - name: "Florent Bédécarrats$^{2}$"
  - name: "Ingrid Dallmann$^{3}$"
  - name: "Holimalala Randriamanampisoa$^{4}$"
institute: "$^{1}$University of Paris Saclay $\\quad$ $^{2}$University Versailles Saint Quentin $\\quad$ $^{3}$Agence Française de Développement $\\quad$ $^{4}$University of Antananarivo"
format:
  beamer:
    aspectratio: 169
    theme: default
...
## To what extent do protected areas (PA) impact household living conditions?
...
- 2008: 3,6% of the territory — 9% population lived < 10 km of PA 
- 2021: 10,8% du territoire — 28% population lived > 10 km of PA 
...
- First national-level evaluation of terrestrial PAs in Madagascar (71 PAs, 2008-2021)

- Robust methodological strategy: matching + DID applied to geolocated household survey data 
...
![](images/result_H1.png){width=100%}
...
::: {.column width="48%"}
 ...
 - Losses associated with restrictions offset by gains elsewhere - (conservation related job, economic activities)
 
 - Offsetting effects may neutralize the overall impact in the short and medium term 
...
![](images/result_H2.png){width=100%}
...
- Inequality is mainly driven by sociodemographic and climate related factors: 
...
![](images/result_H3.png){width=100%}
...
- No significant effect of PA governance categories on the household wealth index
- Results highlights the limits of formal governance categories to explain the socioeconomic outcomes of PA
...
- No significant average effect on the standards of conditions - losses associated with restrictions appear to be offset by adaptation mechanisms and local opportunities 
...
- Across distance thresholds (5km/15km) and alternative outcome variables , results consistently show **no significant effect of PA on household welfare**


**Next steps**:

Understanding the determinants of these impacts: protected area governance and management modalities
...
## Matching {.unnumbered .shrink} (1/2)
...
- **Pseudo-panel analysis**: the results confirm the robustness of the conclusions in that environmental and spatial conditions have a stronger influence on household living conditions than sociodemographic characteristics
