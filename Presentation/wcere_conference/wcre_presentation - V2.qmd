...
institute: "$^{1}$University of Paris Saclay $\\quad$ $^{2}$Université Versailles Saint Quentin $\\quad$ $^{3}$Agence Français du Développement $\\quad$ $^{4}$University of Antananarivo"
format:
  beamer:
    aspectratio: 169
    theme: default
...
##  Our question: **How would household living conditions have evolved if protected areas (PAs) had not been established**
...
\small
\begin{itemize}
\item \textbf{Q1 :} Do protected areas worsen the living conditions of local communities?
\item \textbf{Q2 :} Do protected areas increase inequality among local communities?
\item \textbf{Q3 :} Do the impacts vary by type of protected areas?
\end{itemize}
...
\multirow{-2.2}{2.2cm}{Control variables} & Drought index (SPEI) & \\
\bottomrule
\end{tabular}
}
}
...
::: {.column width="48%"}
  ...
  - **Treatment**: Establishment of PAs

  - **Treatment group**: Households located in clusters < 10 km of PAs created between 2008 and 2021 in rural areas  
  - **Control group**: Households located in clusters > 10 km of PAs created between 2008 and 2021 in rural areas
  - **Excluded group**: Households located in clusters within < 10 km of PAs created before 2008 and in urban areas 
