...
## Verification that rural wealth centiles can be derived from existing data
...
## Construction of rural wealth centiles across surveys
...
The rural wealth centiles are now computed consistently across survey years, using the national wealth index as a starting point, with (`wealth_centile_rural_weighted`) and without (`wealth_centile_rural_simple`) survey wheighing.